...
@section('content')
    <h1 class="text-3xl font-bold mb-6">Editar Asignación</h1>
    ...
    <form class="space-y-4" action="{{ route('event-evaluators.update', $eventEvaluator->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="rol" value="{{ old('rol', $eventEvaluator->rol) }}" class="border border-gray-300 rounded px-4 py-2">
